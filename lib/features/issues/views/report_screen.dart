...
class _ReportScreenState extends State<ReportScreen> {
  ...
  Future<void> _submit() async {
    ...
    final location = _locationC.text.trim().isNotEmpty
        ? _locationC.text.trim() : 'Field Location';
    ...
    try {
      ...
      await AuditService.log(docRef.id, 'Field staff report submitted — AI refining in background');

      // ── STEP 2: Close screen immediately ──────────────────────────────────
      if (mounted) context.pop();

      // ── STEP 3: Background AI + Geocoding + Image ─────────────────────────
  ...
  Future<void> _runBackgroundProcessing(
    ...
    try {
      ...
      if (!_isCoords(location) && location != 'Field Location') {
        try {
      ...
      final imageUrlFuture = imageFile != null
          ? ImageService.upload(imageFile, folder: 'field_reports')
      ...
      if (duplicateId != null) {
        ...
        await AuditService.log(duplicateId, 'Field report merged with duplicate. Total reports incremented.');
        await docRef.delete();
        return;
      }
  ...
  @override
  void dispose() { _titleC.dispose(); _locationC.dispose(); super.dispose(); }

  @override
  Widget build(BuildContext context) {
    final cs = Theme.of(context).colorScheme;
    return Scaffold(
      appBar: AppBar(title: const Text('Report a Field Need')),
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          Container(
            ...
            child: const Row(children: [
              ...
              SizedBox(width: 8),
              Expanded(child: Text(
                  'Report submits instantly.\n'
                  'AI scores priority in the background.',
          ...
          TextField(
            ...
            decoration: const InputDecoration(
                ...
                hintText: 'e.g. Fire accident, flood, medical emergency...',
          ...
          OutlinedButton.icon(
            ...
            icon: Icon(
                _image == null ? Icons.camera_alt_rounded : Icons.check_circle_rounded,
